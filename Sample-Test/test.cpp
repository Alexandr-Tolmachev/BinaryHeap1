...
TEST(VectorTest, SmallAddTest_1) {
	Array <int> arr;
	for (int i = 1; i <= 10; i++) {
		arr.add(i);
	}
...
TEST(VectorTest, BadPopTest_2) {
	Array <int> arr;
	ASSERT_THROW(arr.pop_back(), std::logic_error);
}

TEST(VectorTest, AddPopTest_3) {
	Array <int> arr;
